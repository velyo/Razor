...
namespace Microsoft.VisualStudio.Mac.LanguageServices.Razor
{
    internal class DefaultFileChangeTracker : FileChangeTracker
    {
        ...
        private readonly string _normalizedFullPath;
            ...
            ForegroundDispatcher foregroundDispatcher)
        {
            ...
            FilePath = filePath;
            _normalizedFullPath = NormalizePath(FilePath);
        ...
        // Virtual for testing
        protected virtual void DetatchFromFileServiceEvents()
        {
            FileService.FileChanged -= FileService_FileChanged;
            FileService.FileCreated -= FileService_FileCreated;
            FileService.FileRemoved -= FileService_FileRemoved;
        ...
        private void HandleFileChangeEvent(FileChangeKind changeKind, FileEventArgs args)
        {
            ...
            foreach (var fileEvent in args)
            {
                ...
                if (string.Equals(_normalizedFullPath, normalizedEventPath, StringComparison.OrdinalIgnoreCase))
                {
